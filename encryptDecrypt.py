...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('Smity003', 'Please Choose one of Encryption or Decrption. Try again.')
...
ShowBtn = Button(wn,text="Show Message",bg='cyan', fg='black',width=15,height=1,command=Result)
